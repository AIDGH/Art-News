...
آخرین به‌روزرسانی محتوایی: ۲۰۲۶-۰۹-۰۲
...
اختصاصی به‌صورت WebP محلی جایگزین تصویرهای remote قالب شده‌اند. محتوای نمایشی
به حوزه سینما بازنویسی شده، منوی همبرگری مشترک روی موبایل و دسکتاپ فعال است و
جایگاه‌های نمایشی اکران نیوز و تبلیغات در صفحه اصلی، دسته‌بندی و خبر وجود دارند.
...
- هویت بصری نهایی برند «سینما نمایش» هنوز نیازمند تأیید است.
- لوگو و لینک رسمی اکران نیوز و محتوای واقعی تبلیغات هنوز دریافت نشده‌اند.
- اسلایدر خبرهای مهم، نوار متحرک اخبار و جست‌وجوی بازشونده موبایل هنوز
  پیاده‌سازی نشده‌اند.
