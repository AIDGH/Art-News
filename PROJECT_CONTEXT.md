...
ارائه‌شده توسط کاربر نیز با تصویر محلی و متن کامل در سایت قرار دارند. منوی
همبرگری مشترک روی موبایل و دسکتاپ فعال است و جایگاه‌های نمایشی اکران نیوز و
تبلیغات در صفحه اصلی، دسته‌بندی و خبر وجود دارند.
...
- نوار متحرک اخبار با پشتیبانی کامل از RTL، توقف انیمیشن با hover و یکپارچگی مستقیم زیر هدر در صفحه اصلی پیاده‌سازی شده است. اسلایدر خبرهای مهم، جست‌وجوی بازشونده موبایل و هدر Mobile-first نیز پیاده‌سازی شده‌اند.
