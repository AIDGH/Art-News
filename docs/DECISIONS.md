...
## 13. Use Horizontal Desktop Navigation and a Mobile Drawer
...
شامل خبر، نقد و یادداشت، گفت‌وگو و گزارش است. Drawer با کلیک بیرون، Escape و
...
چهار خبر نخست صفحه اصلی در یک اسلایدر کنترل‌شده با دکمه، indicator و Drag
افقی مبتنی بر Pointer Events نمایش داده می‌شوند؛ بنابراین موس، قلم و لمس رفتار
یکسانی دارند. در منطق RTL، خبر نخست در سمت راست indicator است، کشیدن انگشت از
چپ به راست و فلش چپ شماره خبر را افزایش می‌دهد و جهت معکوس شماره را کاهش
می‌دهد. اسلایدهای clone ابتدا و انتهای track را به یک حلقه پیوسته تبدیل می‌کنند.
تمام سطح تصویر و متن لینک خبر است و فقط حرکت واقعی Drag کلیک بعدی را خنثی
می‌کند. حرکت خودکار اضافه نشده تا مطالعه تیترها مختل نشود.

## 20. Prefer a Compact Homepage for the Initial Editorial Volume
