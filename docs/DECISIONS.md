...
یکسانی دارند. فلش چپ خبر قبلی و فلش راست خبر بعدی را نمایش می‌دهد و کنترل‌ها
در ابتدا و انتهای فهرست غیرفعال می‌شوند. حرکت خودکار اضافه نشده تا مطالعه
تیترها مختل نشود و رفتار رابط برای کاربر قابل‌کنترل بماند.
