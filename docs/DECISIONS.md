...
چهار خبر نخست صفحه اصلی در یک اسلایدر کنترل‌شده با دکمه، indicator و swipe
لمسی نمایش داده می‌شوند. حرکت خودکار اضافه نشده تا مطالعه تیترها مختل نشود و
رفتار رابط برای کاربر قابل‌کنترل بماند.
