  ...
  return (
    ...
    >
      ...
      <Link
        ...
        className="bg-orange-600 text-white font-medium border-none hover:bg-orange-500 transition-colors shadow-lg rounded-lg px-5 py-2.5 text-sm whitespace-nowrap flex items-center justify-center"
      >
