      ...
      <div className="admin-editor-grid">
        ...
        <aside className="admin-editor-sidebar">
          <section className="admin-card">
            ...
            <label className="admin-check"><input type="checkbox" checked={featured} onChange={(event) => setFeatured(event.target.checked)} /><span><strong>خبر مهم صفحه اول</strong><small>در اسلایدر بالای صفحه نمایش داده شود</small></span></label>
