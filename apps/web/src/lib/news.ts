...
export const articles: Article[] = [
  {
    ...
    lead:
      "علی فروتن، محمد مسلمی و حمید گلی پس از ۱۴ سال در فیلم سینمایی «شوتینگا» بار دیگر کنار یکدیگر قرار می‌گیرند.",
  ...
  },
  {
    ...
    lead:
      "هم‌زمان با اعلام زمان اکران فیلم «بُت»، نخستین تصویر از تازه‌ترین ساخته حمید نعمت‌الله منتشر شد.",
    category: categoryBySlug["news"],
